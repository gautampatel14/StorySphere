...
class ContactForm(forms.Form):
    ...
    def clean(self):
        ...
        if phone == '' and email == '':
            ...
            self.add_error("phone_no", "Email or Phone should be field")
...
class PostForm(ModelForm):
    content = forms.CharField(widget=TinyMCE(attrs={'cols': 80, 'rows': 30}))  # giving some styles.
